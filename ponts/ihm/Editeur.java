...
public class Editeur extends JPanel implements ActionListener, MouseInputListener {
    ...
    private void ihm() {
        ...
        JLabel texteFichier = new JLabel("File");
        ...
        JLabel texteCreation = new JLabel("Create");
        ...
        JLabel pointCommande = new JLabel("Left click:");
        colonnePoint.add(pointCommande);
        JLabel point = new JLabel("add a point");
        colonnePoint.add(point);

        JPanel colonneLiaison = new Colonne();
        bas.add(colonneLiaison);
        JLabel liaisonCommande = new JLabel("Right click:");
        colonneLiaison.add(liaisonCommande);
        JLabel liaison = new JLabel("add a link");
